...
public class Hatice_US04 {
    @Test
    public void pozitiveTestUS4TC1TC2()  {
    ...
    @Test
    public void negativeTestNotFirstNameUS4() {
        ReusableMethods.loginSingIn();
        HomePageUS4 homePage4=new HomePageUS4();
        homePage4.myAccount.click();
        ReusableMethods.waitFor(2);
    ...
    @Test
    public void negativeTestNotLastNameUS4()  {
        ReusableMethods.loginSingIn();
        HomePageUS4 homePage4=new HomePageUS4();
        homePage4.myAccount.click();
        ReusableMethods.clickByJS(homePage4.adresses);
    ...
    @Test
    public void negativeTestNotStreetAddressUS4() {
        ReusableMethods.loginSingIn();
        HomePageUS4 homePage4=new HomePageUS4();
        homePage4.myAccount.click();
        ReusableMethods.clickByJS(homePage4.adresses);
    ...
    @Test
    public void negativeTestNotPostCodeUS4()  {
        ReusableMethods.loginSingIn();
        HomePageUS4 homePage4=new HomePageUS4();
        homePage4.myAccount.click();
        ReusableMethods.clickByJS(homePage4.adresses);
