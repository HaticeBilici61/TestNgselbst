...
@Listeners(team.utilities.Listeners.class)
public class Hatice_US03 {

    @Test
    public void pozitiveTestUS3TC1TC2()  {
  ...
  @Test
    public void negativeTestNotFirstNameUS3()  {
     ReusableMethods.loginSingIn();
      HomePageUS3 homePage3=new HomePageUS3();
    ...
    @Test
    public void negativeTestNotLastNameUS3()  {
        ReusableMethods.loginSingIn();
        HomePageUS3 homePage3=new HomePageUS3();
        homePage3.myAccount.click();
        ReusableMethods.clickByJS(homePage3.adresses);
    ...
    @Test
    public void negativeTestNotStreetAddressUS3()  {
       ReusableMethods.loginSingIn();
        HomePageUS3 homePage3=new HomePageUS3();
        homePage3.myAccount.click();
        ReusableMethods.clickByJS(homePage3.adresses);
    ...
    @Test
    public void negativeTestNotPostCodeUS3()  {
        ReusableMethods.loginSingIn();
        HomePageUS3 homePage3=new HomePageUS3();
        homePage3.myAccount.click();
        ReusableMethods.clickByJS(homePage3.adresses);
    ...
    @Test
    public void negativeTestNotTownCityUS3()  {
        ReusableMethods.loginSingIn();
        HomePageUS3 homePage3=new HomePageUS3();
        homePage3.myAccount.click();
        ReusableMethods.clickByJS(homePage3.adresses);
    ...
    @Test
    public void negativeTestNotPhoneUS3()  {
       ReusableMethods.loginSingIn();
        HomePageUS3 homePage3=new HomePageUS3();
        homePage3.myAccount.click();
        ReusableMethods.waitFor(2);
